...
5. Qualification finale : python3 scripts/doctor.py test (verdict en 3 lignes) puis passe a l'accueil : presente docs/GUIDE-UTILISATION.md et la commande /analyse
