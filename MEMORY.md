...
Definir la roadmap v2 avec l'analyste (aucune etape technique en attente - kit v1.2 qualifie, doctor check/test verts) :

1. Priorite naturelle d'apres les limites connues : **disque complet** (E01/AFF4/raw - The Sleuth Kit deja embarque, fls/icat testes) - catalogue SF-D, connaissances acquisition disque, wrapper, E2E
2. Alternatives a arbitrer : navigateurs, conteneurs, cloud, mobile
3. Premiere investigation reelle sur affaire de production pour roder la chaine complete (retour d'experience a journaliser)
