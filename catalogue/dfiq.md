...
<!-- genere:dfiq:debut -->
Index genere depuis le corpus bake (6 scenarios, 30 facets, 90 questions, 19 approches) - ne pas editer cette section.

## S1001 - Data Exfiltration [-]
Facets : 7 ; questions : 33
### F1007 - Are there any indications of anti-forensic efforts?
- Q1024 : Was an Incognito/Private browser session used? (approches : 1)
- Q1028 : Was there specialized "anti-forensic" (or "privacy") software on a computer?
 (approches : 0)
- Q1029 : Were any encryption programs used on a computer? (approches : 0)
- Q1030 : Were any security or monitoring agents tampered with or disabled? (approches : 0)
- Q1032 : What actions were taken in an Incognito (or "private") browser session?
 (approches : 0)
- Q1033 : Was shell history cleared? (approches : 0)
- Q1074 : Were any system event logs cleared? (approches : 2)
### F1008 - Are there signs of staging data for future exfiltration?
- Q1001 : What files were downloaded using a web browser? (approches : 4)
- Q1004 : What screenshots were taken on a computer? (approches : 0)
- Q1005 : What files have ever been on a computer? (approches : 0)
- Q1006 : What files are present on a computer? (approches : 0)
- Q1017 : Were any files collected into a container? (approches : 0)
- Q1034 : Was content copied from a file? (approches : 0)
- Q1035 : Were any copies made of sensitive files? (approches : 0)
- Q1077 : Were there bulk downloads from Google Drive? (approches : 0)
### F1009 - Was any sensitive data sent externally via email?
- Q1016 : What files were sent externally via email attachments? (approches : 0)
- Q1075 : Is the recipient account controlled by the sender? (approches : 0)
- Q1076 : Were the files screenshots? (approches : 0)
- Q1078 : Were the files copies? (approches : 0)
- Q1079 : Is there a history of communication with the recipients? (approches : 0)
- Q1080 : How many external recipients does the email have? (approches : 0)
### F1010 - Was any sensitive data exfiltrated via a physical medium?
- Q1003 : What files were copied from a computer to a USB device? (approches : 0)
- Q1010 : What was printed from a computer? (approches : 0)
### F1011 - Was any sensitive data exfiltrated via a web service?
- Q1007 : What files were synced or backed-up to external services? (approches : 0)
- Q1009 : What interactions with external cloud storage sites did the actor have using their web browser?
 (approches : 0)
- Q1011 : What files were sent or received by a chat application? (approches : 0)
- Q1025 : What external accounts has the actor used in their web browser? (approches : 0)
- Q1038 : Were any files sent via CLI utilities? (approches : 0)
- Q1084 : What data was uploaded to a website via a web browser? (approches : 0)
### F1012 - System Information
- Q1008 : What programs are installed on a computer? (approches : 0)
- Q1081 : Does the user have a recently provisioned host? (approches : 0)
### F1026 - Were any files sent via other network media?
- Q1082 : Were any files sent via AirDrop? (approches : 0)
- Q1083 : Were any files sent via Bluetooth? (approches : 0)
...
- Q1005 : What files have ever been on a computer? (approches : 0)
- Q1006 : What files are present on a computer? (approches : 0)
- Q1014 : What files did the actor open on their computer? (approches : 0)
- Q1027 : Are there any sudden changes in the number of files on a device? (approches : 0)
...
- Q1015 : What syncing activities did external "cloud storage" applications do on a computer?
 (approches : 0)
- Q1025 : What external accounts has the actor used in their web browser? (approches : 0)
- Q1026 : What files were downloaded from messaging apps? (approches : 0)
- Q1031 : How much network traffic was there to/from a machine? (approches : 0)
### F1003 - Has the actor introduced any ExternalCompany files to Company assets via removable storage devices?

- Q1002 : What USB devices were attached to a computer? (approches : 0)
- Q1012 : What files were copied from a USB device to a computer? (approches : 0)
- Q1013 : What files are present on a USB device? (approches : 0)
### F1029 - Are there any indications of communication with ExternalCompany?
- Q1020 : What pages did web browsers visit? (approches : 2)
- Q1084 : What data was uploaded to a website via a web browser? (approches : 0)
- Q1085 : What DNS requests have been made from a system? (approches : 0)
- Q1086 : What web-based email messages were viewed in a web browser? (approches : 0)
### F1030 - Has the actor connected to any ExternalCompany systems?

- Q1087 : Did the user access any common PaaS/SaaS services? (approches : 0)
- Q1088 : Did the user connect to any non-Company systems using the command line?
 (approches : 0)
- Q1089 : Did the user download any Citrix configuration (.ica) files? (approches : 0)
- Q1090 : Did the user interact with any git repositories? (approches : 0)
...
- Q1018 : What process made the DNS query? (approches : 4)
- Q1073 : Have there been any modifications to the "hosts" file? (approches : 0)
### F1005 - Was a user's web browsing the cause of a given DNS query?
- Q1019 : What web browsers were running at a given time? (approches : 1)
- Q1020 : What pages did web browsers visit? (approches : 2)
- Q1024 : Was an Incognito/Private browser session used? (approches : 1)
- Q1072 : Did Chrome's DNS Prefetching cause a DNS query? (approches : 0)
### F1006 - Was a browser extension responsible for a DNS query?
- Q1021 : What Chrome extensions are installed? (approches : 0)
- Q1022 : What actions did a Chrome extension perform? (approches : 0)
- Q1023 : Is a given Chrome extension associated with a given domain? (approches : 0)
...
- Q1039 : Are there any detections of exposed service account credentials? (approches : 0)
...
- Q1042 : Are there any APIs recently enabled? (approches : 0)
- Q1043 : Are there any role bindings to cluster admin for anonymous users? (approches : 0)
- Q1044 : Are there any unexpected resources created under the cloud project?
 (approches : 0)
- Q1045 : Are there any unknown accounts created? (approches : 0)
- Q1046 : Are there any unknown role bindings created? (approches : 0)
...
- Q1021 : What Chrome extensions are installed? (approches : 0)
- Q1052 : What browser extensions (non-Chrome) are installed? (approches : 0)
### F1020 - Are there any interesting logon or boot initialization scripts?
- Q1053 : What Launch Agents are configured? (approches : 0)
- Q1054 : What Launch Daemons are configured? (approches : 0)
- Q1055 : What Windows logon scripts are configured? (approches : 0)
- Q1056 : What login hooks are configured? (approches : 0)
- Q1057 : What network logon scripts are configured? (approches : 0)
### F1021 - Are there any new accounts that have been created?
- Q1058 : What domain accounts have been created? (approches : 0)
- Q1059 : What local accounts have been created? (approches : 0)
### F1022 - Are there any scheduled/automated tasks that ran?
- Q1060 : What AT jobs are configured? (approches : 0)
- Q1061 : What Scheduled Tasks are configured? (approches : 0)
- Q1062 : What cron jobs are configured? (approches : 0)
- Q1063 : What periodic scripts are configured? (approches : 0)
- Q1064 : What systemd timers are configured? (approches : 0)
### F1023 - Are there any suspicious files running at system boot or login autoruns?

- Q1065 : What files are referenced in Registry "Run" keys? (approches : 0)
- Q1066 : What items are in startup folders? (approches : 0)
### F1024 - Has a system process been created or modified?
- Q1067 : What system services are installed? (approches : 0)
- Q1068 : When were system services last modified? (approches : 0)
### F1025 - Are there any indications of hijacking execution flows?
- Q1069 : Are there any indications of dylib hijacking? (approches : 0)
- Q1070 : Are there any indications of dylib proxying? (approches : 0)
- Q1071 : Are there any indications of dynamic linker hijacking? (approches : 0)
...
- Q1036 : Have there been any executions of PsExec? (approches : 2)
### F1028 - Are the indications of an attacker moving TO this host?
- Q1037 : Have there been any executions of PsExeSrv? (approches : 3)
