...
5. **Passer a l'accueil** : presente le guide de demarrage rapide (`docs/QUICK-START.md` ou `.fr.md` selon la langue de l'analyste) et `docs/USER-GUIDE.fr.md` - l'analyste lance ensuite son outil agentique directement dans le dossier du kit ; chaque session commence par l'autotest (verdict doctor) puis le routage (guidage ou accueil)
