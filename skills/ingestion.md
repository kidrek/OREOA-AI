...
| `History`, `Cookies`, `Web Data`, `Login Data` | bases Chromium (sans extension - identification par tables) | navigateur |
| `places.sqlite`, `cookies.sqlite` | bases Firefox | navigateur |
| `History.db` | base Safari | navigateur |
